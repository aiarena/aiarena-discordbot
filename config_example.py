...
# role ids
AI_ARENA_GUILD_ID = 430111136822722590
...
ROLES_IDS = {}
ROLES_IDS[AI_ARENA_GUILD_ID] = [AA_BOT_AUTHOR_ID, AA_DONATOR_ID]
ROLES_IDS[SC2AI_GUILD_ID] = [SC2_BOT_AUTHOR_ID, SC2_DONATOR_ID]
